	...
	if (this.buttonContainer != null)
	{
			...
			!this.isOfflineApp() && file != null)
		{
			if (this.shareButton == null)
			{
				...
				this.shareButton.style.backgroundColor = '#124191';
...
App.prototype.updateHeader = function()
{
	if (this.menubar != null)
	{
		...
		var logo = 'url("https://download.logo.wine/logo/Nokia/Nokia-Logo.wine.png")';
		...
		this.appIcon.style.backgroundColor = 'white';
